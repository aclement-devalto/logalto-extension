(function() {
	...
	'				<h3><span class="title">{{currentPage.activeCommand.title}}</span><span class="glyphicon"></span><div class="spinner"><div class="double-bounce1"></div><div class="double-bounce2"></div></div><div class="loading-message">Processing</div></h3>' + 
